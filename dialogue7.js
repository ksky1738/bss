...
window.dialogue_polarBear=function(player,items,NPCs){
    ...
    return function(diff){
        ...
        rew.push(['ticket', rewm])
         ...
         rew.push(['oil', rewm])
         rew.push(['enzymes', rewm])
         rew.push(['glue', rewm])
         rew.push(['blueberry', rewm])
            ...
            function(){
                ...
                switch((player.discoveredBees.length>24&&rand()<0.5?rand()*8:rand()*7+1)|0){
                    ...
                    case 1:
                        ...
                        player.addQuest('Choco Milk Shake',[['pollenFromSpiderField',1],['werewolf',0]],'polarBear')
                        rew.push(['gumdrops',3])
                    ...
                    case 5:
                        ...
                        player.addQuest('Beetle Brew',[['pollenFromPineapplePatch',0],['pollenFromDandelionField',0],['ladybug',1],['rhinoBeetle',0]],'polarBear')
